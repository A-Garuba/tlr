            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  <svg
                    className="h-8 w-8 fill-current text-primary-600"
                    viewBox="0 0 32 32"
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="mb-4 flex md:order-1 md:mb-0 md:ml-4">
              <li>
                <Link
                  href="/"
                  className="flex items-center justify-center rounded-full bg-gray-800 text-primary-600 transition duration-150 ease-in-out hover:bg-primary-600 hover:text-gray-100"
                  aria-label="Twitter"
                >
                  <svg
