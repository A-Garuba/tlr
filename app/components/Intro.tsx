...
const Intro = ({ onEnter }: any) => {
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="mt-10">
        <button
          className="py-2 px-4 rounded-full bg-transparent border border-gray-500 transition-all duration-300 hover:bg-primary hover:text-black hover:scale-110 hover:bg-opacity-95"
          onClick={onEnter}
        >
          Enter
        </button>
